    ...
    >
      <div className="w-full max-w-4xl px-4 md:px-8 mx-auto">
        <SectionHeader
          ...
          desc="My educational background and qualifications."
...
const EducationCard = ({
  ...
  education: typeof ACADEMIC_JOURNEY[0];
  index: number;
}) => {
  return (
    <motion.div
      ...
      >
        <CardHeader className="pb-3">
          <div className="flex flex-col md:flex-row md:items-start justify-between gap-4">
            ...
            <Badge variant="secondary" className="w-[fit-content] font-mono text-xs font-normal">
              {education.date}
            </Badge>
          </div>
        </CardHeader>
